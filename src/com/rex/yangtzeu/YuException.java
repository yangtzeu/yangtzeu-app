...
public class YuException extends Exception implements UncaughtExceptionHandler {
	/** Debug Log Tag */  
    public static final String TAG = "CrashHandler";  
    /** 是否开启日志输出, 在Debug状态下开启, 在Release状态下关闭以提升程序性能 */  
    public static final boolean DEBUG = true;  
    /** CrashHandler实例 */  
    private static YuException INSTANCE;  
    /** 程序的Context对象 */  
    ...
    public static YuException getInstance() {  
        if (INSTANCE == null)  
            INSTANCE = new YuException();  
        return INSTANCE;  
    }  
